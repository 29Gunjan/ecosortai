...
For easy deployment to a free hosting platform:

1. Run the deployment script: `deploy.bat` (Windows) or `bash deploy.sh` (Linux/Mac)
2. Follow the instructions to deploy to Render.com (free tier, no credit card required)

See the [Deployment Guide](DEPLOYMENT.md) for more detailed deployment options.
